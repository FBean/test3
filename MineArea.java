...
public class MineArea extends JPanel implements ActionListener,MouseListener{
     ...
     public MineArea(int row,int colum,int mineCount,int grade) {
         ...
         showTime=new JTextField(4);
         str="爆炸声.wav";
         showMarkedMineCount=new JTextField(4);
         showTime.setHorizontalAlignment(JTextField.CENTER);
         showTime.setForeground(new Color(255,0,0));//////////////
         showMarkedMineCount.setHorizontalAlignment(JTextField.CENTER);
         showMarkedMineCount.setForeground(new Color(255,0,0));////////////
         showMarkedMineCount.setFont(new Font("Arial",Font.BOLD,20));
         showTime.setFont(new Font("Arial",Font.BOLD,20));         
         pCenter=new JPanel();
         pNorth=new JPanel();
         lay=new LayMines();             
